...
;;;;; basics
   ...
   `(region ((,class (:foreground ,bg :background ,yellow-2))))
   ...
   `(show-paren-match-face ((,class (:foreground ,bg :background ,yellow-2))))
   ...
   `(mode-line-inactive ((,class (:foreground ,grey-0 :background ,grey-2 ))))
...
;;;;; powerline
   ...
   `(powerline-inactive1 ((,class (:foreground ,grey-0 :background ,grey-2))))
   `(powerline-inactive2 ((,class (:foreground ,grey-0 :background ,grey-2))))
...
;;;;; smartparens
   `(sp-show-pair-match-face ((,class (:foreground ,bg :background ,cyan-1))))
   `(sp-pair-overlay-face ((,class (:foreground ,fg))))
...
;;;;; helm
   ...
   `(helm-selection ((,class (:foreground ,bg :background ,yellow-2))))
   ...
   `(helm-visible-mark ((,class (:background ,grey-2))))
...
;;;;; company
   ...
   `(company-preview ((,class (:foreground ,blue-1))))
...
;;;;; magit
   `(magit-blame-sha1 ((,class (:foreground ,green-0 :background ,grey-2))))
   `(magit-blame-time ((,class (:foreground ,blue-1 :background ,grey-2))))
   `(magit-blame-header ((,class (:foreground ,blue-1 :background ,grey-2))))
   `(magit-blame-subject ((,class (:foreground ,fg :background ,grey-2))))
   `(magit-blame-culprit ((,class (:foreground ,red-1 :background ,grey-2))))
   ...
   `(magit-hunk-heading ((,class (:background ,grey-2))))
   `(magit-hunk-heading-highlight ((,class (:foreground ,bg :background ,yellow-2))))
   `(magit-log-author ((,class (:foreground ,fg))))
   `(magit-log-head-label-remote ((,class (:foreground ,bg :background ,green-1 :weight bold))))
   `(magit-log-head-label-local ((,class (:foreground ,bg :background ,cyan-1 :weight bold))))
   `(magit-log-head-label-tags ((,class (:foreground ,bg :background ,magenta-2 :weight bold))))
   `(magit-log-head-label-wip ((,class (:foreground ,bg :background ,cyan-2 :weight bold))))
   `(magit-log-head-label-head ((,class (:foreground ,bg :background ,yellow-1 :weight bold))))
   ...
   `(magit-section-highlight ((,class (:foreground ,bg :background ,yellow-2))))
   `(magit-section-title ((,class (:foreground ,magenta-0 :background ,bg :weight bold))))
...
;;;;; org
   ...
   `(org-date-selected ((,class (:foreground ,bg :background ,green-0))))
...
;;;;; other, need more work
   ...
   `(trailing-whitespace ((,class (:foreground ,bg :background ,red-2))))
